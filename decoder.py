...
class GraphDecoder:
    ...
    def net_qubit_flips(self, flips_x, flips_z, decompose=False):
    ...
    def decomposeGate(self, unitary):
        '''Get decomposed unitary angles'''
        return OneQubitEulerDecomposer("ZYZ").angles(unitary)
